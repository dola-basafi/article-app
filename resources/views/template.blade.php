                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item" id="log">
                            <a class="nav-link" href="#">
                                <button onclick="clearAlert()" type="button" class="btn btn-primary"
                        ...
                        <li class="nav-item " id="log-out">
                            <a class="nav-link" href="#">
                                <button onclick="proccesslogout()" type="button" class="btn btn-danger">
                                    Log Out
                                </button>
                            </a>
                        </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form onsubmit="proccesslogin(event)" id="form-login">
                        <div class="alert alert-danger err" role="alert" id="alert-login">
    ...
    <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger err" role="alert" id="alert-regis">
